...
class RegisterSerializer(serializers.ModelSerializer):
    class Meta:
         ...
         fields = ["id","first_name", "last_name", "email", "mobile","password","place","occupation","picture"]
...
class UserInfoUpdatedSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id','first_name','email','is_superuser','profile_picture_url']
...
class UserViewSerializer(serializers.ModelSerializer):
    class Meta:
         ...
         fields = ["id","first_name", "last_name", "email", "mobile","place","occupation","picture",'is_superuser']
